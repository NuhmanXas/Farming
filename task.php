...
<body class="main-layout">
   ...
   <!-- loader -->
   <div class="loader_bg">
      <div class="loader"><img src="C:/Users/dell/Desktop/CRAS_NEW/lighten-1.0.0/images/200w.webp" alt="Loading..." /></div>
   </div>
   <!-- end loader -->
   ...
   <div class="brand_color">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <div class="titlepage">
                  <h2>Track your farming practices</h2>
               </div>
            </div>
         </div>
      </div>
   ...
   <section class="advisory-form-container">
    <form action="submit_advisory.php" method="POST" class="advisory-form">
       <div class="form-group">
        ...
        <div class="form-group">
            <label for="Task_ID">Task No.</label>
            <input type="text" id="Task_ID" name="Task_ID" required>
        </div>

        <div class="form-group">
            <label for="Task_name">Task Name:</label>
            <input type="date" id="Task_name" name="Task_name" required>
         </div>
        <div class="form-group">
